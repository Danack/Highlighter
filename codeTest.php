...
class CodeHighlighter
{
    ...
    public static function highlight($code, $prefix = "php_")
    {
        ...
        if (!$tokenStrings) {
            ...
            array_walk($tokenStrings,
                function ($value, $key) use (&$tokenStrings) {
                    if (strpos($key, 'T_') !== 0) {
...
$highlighted = CodeHighlighter::highlight(file_get_contents(__FILE__));
...
<link href="code_highlight_dark.css" rel="stylesheet" type="text/css">
<!-- <link href="code_highlight_dark.css" rel="stylesheet" type="text/css">' -->
</head>
